...
public class LocalHandler {
    ...
    public static final String MAIN_WEB_FILE_DIRECTORY = "src/main/resources/static";

    // Logger for this class
    private Logger logger = LogManager.getLogger(LocalHandler.class);
    ...
    public String html(@PathParam("file") String file) {
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader(MAIN_WEB_FILE_DIRECTORY + "/" + file + ".html"));
    ...
    public String css(@PathParam("file") String file) {
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader(MAIN_WEB_FILE_DIRECTORY + "/" + file + ".css"));
    ...
    public String javascript(@PathParam("file") String file) {
        try {
            BufferedReader br = new BufferedReader(new FileReader(MAIN_WEB_FILE_DIRECTORY + "/" + file + ".js"));
            StringBuilder sb = new StringBuilder();
            String line = br.readLine();
            while (line != null) {
                sb.append(line).append("\n");
